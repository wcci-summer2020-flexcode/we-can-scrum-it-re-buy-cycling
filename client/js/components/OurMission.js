...
export default function ourMission() {
  ...
  <div class="missionbody">
    <p id="missionp1"> Our mission at ReBuycycle is to ease the burden on families by providing an easier way to replace bikes.  We understand the high cost that can be encountered when purchasing bikes year after year for young children that are out growing their bikes every year. </p> <img class="mission-image1" src="${missionbike1}" alt="bike"><br><br>
    
    <p id="missionp2">With that in mind, ReBuycyle is a resource for parents to utilize and lessen the cost of acquiring new bicycles for their children to enjoy.
